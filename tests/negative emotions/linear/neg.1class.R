# Figure 1 & 2 of manuscript - linear effect of NE on HP

rm(list = ls(all = TRUE)) #clear workspace
#setwd("C:/Documents and Settings/jolynn/Desktop/Fall 2010/CI auto/examples/negative emotions/linear")
#setwd("C:/Documents and Settings/Diane Losardo/Desktop/Quant Research/mixtureproj/workingcode")
setwd("C:/Documents and Settings/pek/Desktop/CEauto/example/negative emotions/linear")
...
if (!equal) {
for (i in seq(LEta1,UEta1,length=points)){
yy <-0
placeholder <-0
	for (j in 1:classes) {
		if (j < classes) {
...
if(equal) { for (i in seq(LEta1,UEta1,length=points)){
...
write.table(out, file='neg.1class.dat', append=FALSE, quote=FALSE,
